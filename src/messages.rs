...
#[allow(dead_code)]
pub const DBC_FILE_NAME: &str = "car.dbc";
...
impl Messages {
    ...
    pub fn from_can_message(id: Id, payload: &[u8]) -> Result<Self, CanError> {
        let res = match id {
            Module1Temps::MESSAGE_ID => {
                Messages::Module1Temps(Module1Temps::try_from(payload)?)
            }
            Module2Temps::MESSAGE_ID => {
                Messages::Module2Temps(Module2Temps::try_from(payload)?)
            }
            Module3Temps::MESSAGE_ID => {
                Messages::Module3Temps(Module3Temps::try_from(payload)?)
            }
            Module4Temps::MESSAGE_ID => {
                Messages::Module4Temps(Module4Temps::try_from(payload)?)
            }
            Module5Temps::MESSAGE_ID => {
                Messages::Module5Temps(Module5Temps::try_from(payload)?)
            }
            ...
            Module2Status::MESSAGE_ID => {
                Messages::Module2Status(Module2Status::try_from(payload)?)
            }
            Module3Status::MESSAGE_ID => {
                Messages::Module3Status(Module3Status::try_from(payload)?)
            }
            Module4Status::MESSAGE_ID => {
                Messages::Module4Status(Module4Status::try_from(payload)?)
            }
            ...
            Msgid0x6b2::MESSAGE_ID => {
                Messages::Msgid0x6b2(Msgid0x6b2::try_from(payload)?)
            }
            Msgid0x6b3::MESSAGE_ID => {
                Messages::Msgid0x6b3(Msgid0x6b3::try_from(payload)?)
            }
            Msgid0x6b4::MESSAGE_ID => {
                Messages::Msgid0x6b4(Msgid0x6b4::try_from(payload)?)
            }
            Msgid0x1806e7f4::MESSAGE_ID => {
                Messages::Msgid0x1806e7f4(Msgid0x1806e7f4::try_from(payload)?)
            }
            Msgid0x1806e5f4::MESSAGE_ID => {
                Messages::Msgid0x1806e5f4(Msgid0x1806e5f4::try_from(payload)?)
            }
            Msgid0x1806e9f4::MESSAGE_ID => {
                Messages::Msgid0x1806e9f4(Msgid0x1806e9f4::try_from(payload)?)
            }
            M173ModulationAndFluxInfo::MESSAGE_ID => {
                Messages::M173ModulationAndFluxInfo(
                    M173ModulationAndFluxInfo::try_from(payload)?,
                )
            }
            M172TorqueAndTimerInfo::MESSAGE_ID => {
                Messages::M172TorqueAndTimerInfo(
                    M172TorqueAndTimerInfo::try_from(payload)?,
                )
            }
            M194ReadWriteParamResponse::MESSAGE_ID => {
                Messages::M194ReadWriteParamResponse(
                    M194ReadWriteParamResponse::try_from(payload)?,
                )
            }
            M193ReadWriteParamCommand::MESSAGE_ID => {
                Messages::M193ReadWriteParamCommand(
                    M193ReadWriteParamCommand::try_from(payload)?,
                )
            }
            M192CommandMessage::MESSAGE_ID => {
                Messages::M192CommandMessage(M192CommandMessage::try_from(payload)?)
            }
            M171FaultCodes::MESSAGE_ID => {
                Messages::M171FaultCodes(M171FaultCodes::try_from(payload)?)
            }
            M170InternalStates::MESSAGE_ID => {
                Messages::M170InternalStates(M170InternalStates::try_from(payload)?)
            }
            M169InternalVoltages::MESSAGE_ID => {
                Messages::M169InternalVoltages(M169InternalVoltages::try_from(payload)?)
            }
            M168FluxIdIqInfo::MESSAGE_ID => {
                Messages::M168FluxIdIqInfo(M168FluxIdIqInfo::try_from(payload)?)
            }
            M167VoltageInfo::MESSAGE_ID => {
                Messages::M167VoltageInfo(M167VoltageInfo::try_from(payload)?)
            }
            M166CurrentInfo::MESSAGE_ID => {
                Messages::M166CurrentInfo(M166CurrentInfo::try_from(payload)?)
            }
            M165MotorPositionInfo::MESSAGE_ID => {
                Messages::M165MotorPositionInfo(
                    M165MotorPositionInfo::try_from(payload)?,
                )
            }
            M164DigitalInputStatus::MESSAGE_ID => {
                Messages::M164DigitalInputStatus(
                    M164DigitalInputStatus::try_from(payload)?,
                )
            }
            M163AnalogInputVoltages::MESSAGE_ID => {
                Messages::M163AnalogInputVoltages(
                    M163AnalogInputVoltages::try_from(payload)?,
                )
            }
            M162TemperatureSet3::MESSAGE_ID => {
                Messages::M162TemperatureSet3(M162TemperatureSet3::try_from(payload)?)
            }
            M161TemperatureSet2::MESSAGE_ID => {
                Messages::M161TemperatureSet2(M161TemperatureSet2::try_from(payload)?)
            }
            M160TemperatureSet1::MESSAGE_ID => {
                Messages::M160TemperatureSet1(M160TemperatureSet1::try_from(payload)?)
            }
            M174FirmwareInfo::MESSAGE_ID => {
                Messages::M174FirmwareInfo(M174FirmwareInfo::try_from(payload)?)
            }
            M175DiagDataMessage::MESSAGE_ID => {
                Messages::M175DiagDataMessage(M175DiagDataMessage::try_from(payload)?)
            }
            BmsCurrentLimit::MESSAGE_ID => {
                Messages::BmsCurrentLimit(BmsCurrentLimit::try_from(payload)?)
            }
            M176FastInfo::MESSAGE_ID => {
                Messages::M176FastInfo(M176FastInfo::try_from(payload)?)
            }
            M177TorqueCapability::MESSAGE_ID => {
                Messages::M177TorqueCapability(M177TorqueCapability::try_from(payload)?)
            }
...
impl Module1Temps {
    ...
    pub fn new(
        ...
        module_voltage_6: f32,
        module_voltage_5: f32,
        module_voltage_4: f32,
        module_voltage_3: f32,
...
impl embedded_can::Frame for Module1Temps {
...
impl embedded_can::Frame for Module2Temps {
    fn new(id: impl Into<Id>, data: &[u8]) -> Option<Self> {
        if id.into() != Self::MESSAGE_ID { None } else { data.try_into().ok() }
    }
    fn new_remote(_id: impl Into<Id>, _dlc: usize) -> Option<Self> {
...
impl embedded_can::Frame for Module3Temps {
    fn new(id: impl Into<Id>, data: &[u8]) -> Option<Self> {
        if id.into() != Self::MESSAGE_ID { None } else { data.try_into().ok() }
    }
    fn new_remote(_id: impl Into<Id>, _dlc: usize) -> Option<Self> {
...
impl embedded_can::Frame for Module4Temps {
    fn new(id: impl Into<Id>, data: &[u8]) -> Option<Self> {
        if id.into() != Self::MESSAGE_ID { None } else { data.try_into().ok() }
    }
    fn new_remote(_id: impl Into<Id>, _dlc: usize) -> Option<Self> {
...
impl embedded_can::Frame for Module5Temps {
    fn new(id: impl Into<Id>, data: &[u8]) -> Option<Self> {
        if id.into() != Self::MESSAGE_ID { None } else { data.try_into().ok() }
    }
    fn new_remote(_id: impl Into<Id>, _dlc: usize) -> Option<Self> {
...
impl embedded_can::Frame for PrechargeStatus {
    fn new(id: impl Into<Id>, data: &[u8]) -> Option<Self> {
        if id.into() != Self::MESSAGE_ID { None } else { data.try_into().ok() }
    }
    fn new_remote(_id: impl Into<Id>, _dlc: usize) -> Option<Self> {
...
impl embedded_can::Frame for VcuStatus {
    fn new(id: impl Into<Id>, data: &[u8]) -> Option<Self> {
        if id.into() != Self::MESSAGE_ID { None } else { data.try_into().ok() }
    }
    fn new_remote(_id: impl Into<Id>, _dlc: usize) -> Option<Self> {
...
impl embedded_can::Frame for VcuPedalReadings {
    fn new(id: impl Into<Id>, data: &[u8]) -> Option<Self> {
        if id.into() != Self::MESSAGE_ID { None } else { data.try_into().ok() }
    }
    fn new_remote(_id: impl Into<Id>, _dlc: usize) -> Option<Self> {
...
impl VcuPedalThresholdSettings {
    ...
    pub fn vcu_pedals_settings_mux(
        &mut self,
    ) -> Result<VcuPedalThresholdSettingsVcuPedalsSettingsMuxIndex, CanError> {
        match self.vcu_pedals_settings_mux_raw() {
            0 => {
                Ok(
                    VcuPedalThresholdSettingsVcuPedalsSettingsMuxIndex::M0(VcuPedalThresholdSettingsVcuPedalsSettingsMuxM0 {
                        raw: self.raw,
                    }),
                )
            }
            1 => {
                Ok(
                    VcuPedalThresholdSettingsVcuPedalsSettingsMuxIndex::M1(VcuPedalThresholdSettingsVcuPedalsSettingsMuxM1 {
                        raw: self.raw,
                    }),
                )
            }
            2 => {
                Ok(
                    VcuPedalThresholdSettingsVcuPedalsSettingsMuxIndex::M2(VcuPedalThresholdSettingsVcuPedalsSettingsMuxM2 {
                        raw: self.raw,
                    }),
                )
            }
            multiplexor => {
                Err(CanError::InvalidMultiplexor {
                    message_id: VcuPedalThresholdSettings::MESSAGE_ID,
    ...
    pub fn set_m0(
        &mut self,
        value: VcuPedalThresholdSettingsVcuPedalsSettingsMuxM0,
    ) -> Result<(), CanError> {
    ...
    pub fn set_m1(
        &mut self,
        value: VcuPedalThresholdSettingsVcuPedalsSettingsMuxM1,
    ) -> Result<(), CanError> {
        let b0 = BitArray::<_, LocalBits>::new(self.raw);
        let b1 = BitArray::<_, LocalBits>::new(value.raw);
        self.raw = b0.bitor(b1).into_inner();
    ...
    pub fn set_m2(
        &mut self,
        value: VcuPedalThresholdSettingsVcuPedalsSettingsMuxM2,
    ) -> Result<(), CanError> {
        let b0 = BitArray::<_, LocalBits>::new(self.raw);
        let b1 = BitArray::<_, LocalBits>::new(value.raw);
        self.raw = b0.bitor(b1).into_inner();
...
impl embedded_can::Frame for VcuPedalThresholdSettings {
    fn new(id: impl Into<Id>, data: &[u8]) -> Option<Self> {
        if id.into() != Self::MESSAGE_ID { None } else { data.try_into().ok() }
    }
    fn new_remote(_id: impl Into<Id>, _dlc: usize) -> Option<Self> {
...
pub enum VcuPedalThresholdSettingsVcuPedalsSettingsMuxIndex {
...
#[derive(Default)]
pub struct VcuPedalThresholdSettingsVcuPedalsSettingsMuxM0 {
    raw: [u8; 7],
}
#[allow(
    clippy::absurd_extreme_comparisons,
...
#[derive(Default)]
pub struct VcuPedalThresholdSettingsVcuPedalsSettingsMuxM1 {
    raw: [u8; 7],
}
#[allow(
    clippy::absurd_extreme_comparisons,
...
#[derive(Default)]
pub struct VcuPedalThresholdSettingsVcuPedalsSettingsMuxM2 {
    raw: [u8; 7],
}
#[allow(
    clippy::absurd_extreme_comparisons,
...
impl VcuLifetimeDistanceAndOntime {
    ...
    pub fn set_vcu_lifetime_distance(&mut self, value: u32) -> Result<(), CanError> {
        if value < 0_u32 || 4294967295_u32 < value {
            return Err(CanError::ParameterOutOfRange {
                message_id: VcuLifetimeDistanceAndOntime::MESSAGE_ID,
            });
        }
        let factor = 1;
        let value = value
...
impl embedded_can::Frame for VcuLifetimeDistanceAndOntime {
    fn new(id: impl Into<Id>, data: &[u8]) -> Option<Self> {
        if id.into() != Self::MESSAGE_ID { None } else { data.try_into().ok() }
    }
    fn new_remote(_id: impl Into<Id>, _dlc: usize) -> Option<Self> {
...
impl DashButtons {
    ...
    pub fn new(
        ...
        dash_button4status: bool,
        dash_button3status: bool,
...
impl embedded_can::Frame for DashButtons {
    fn new(id: impl Into<Id>, data: &[u8]) -> Option<Self> {
        if id.into() != Self::MESSAGE_ID { None } else { data.try_into().ok() }
    }
    fn new_remote(_id: impl Into<Id>, _dlc: usize) -> Option<Self> {
...
impl AcuBoardData {
    ...
    pub fn set_board_humidity(&mut self, value: u8) -> Result<(), CanError> {
        if value < 0_u8 || 127_u8 < value {
            return Err(CanError::ParameterOutOfRange {
                message_id: AcuBoardData::MESSAGE_ID,
            });
        }
        let factor = 1;
        let value = value
...
impl embedded_can::Frame for AcuBoardData {
    fn new(id: impl Into<Id>, data: &[u8]) -> Option<Self> {
        if id.into() != Self::MESSAGE_ID { None } else { data.try_into().ok() }
    }
    fn new_remote(_id: impl Into<Id>, _dlc: usize) -> Option<Self> {
...
impl Msgid0x6b1 {
    ...
    pub fn set_pack_summed_voltage(&mut self, value: f32) -> Result<(), CanError> {
        if value < 0_f32 || 0_f32 < value {
            return Err(CanError::ParameterOutOfRange {
                message_id: Msgid0x6b1::MESSAGE_ID,
            });
        }
        let factor = 0.01_f32;
        let offset = 0_f32;
    ...
    pub fn pack_current_raw(&self) -> f32 {
        let signal = self.raw.view_bits::<Msb0>()[0..16].load_be::<i16>();
        let factor = 0.1_f32;
        let offset = 0_f32;
        (signal as f32) * factor + offset
    }
...
impl embedded_can::Frame for Msgid0x6b1 {
    fn new(id: impl Into<Id>, data: &[u8]) -> Option<Self> {
        if id.into() != Self::MESSAGE_ID { None } else { data.try_into().ok() }
    }
    fn new_remote(_id: impl Into<Id>, _dlc: usize) -> Option<Self> {
...
impl Msgid0x6b2 {
    ...
    pub fn set_low_cell_voltage(&mut self, value: f32) -> Result<(), CanError> {
        if value < 0_f32 || 0_f32 < value {
            return Err(CanError::ParameterOutOfRange {
                message_id: Msgid0x6b2::MESSAGE_ID,
            });
        }
        let factor = 0.0001_f32;
        let offset = 0_f32;
...
impl embedded_can::Frame for Msgid0x6b2 {
    fn new(id: impl Into<Id>, data: &[u8]) -> Option<Self> {
        if id.into() != Self::MESSAGE_ID { None } else { data.try_into().ok() }
    }
    fn new_remote(_id: impl Into<Id>, _dlc: usize) -> Option<Self> {
...
impl Msgid0x6b3 {
    ...
    pub fn set_pack_soc(&mut self, value: f32) -> Result<(), CanError> {
        if value < 0_f32 || 0_f32 < value {
            return Err(CanError::ParameterOutOfRange {
                message_id: Msgid0x6b3::MESSAGE_ID,
            });
        }
        let factor = 0.5_f32;
        let offset = 0_f32;
...
impl embedded_can::Frame for Msgid0x6b3 {
    fn new(id: impl Into<Id>, data: &[u8]) -> Option<Self> {
        if id.into() != Self::MESSAGE_ID { None } else { data.try_into().ok() }
    }
    fn new_remote(_id: impl Into<Id>, _dlc: usize) -> Option<Self> {
...
impl embedded_can::Frame for Msgid0x6b4 {
    fn new(id: impl Into<Id>, data: &[u8]) -> Option<Self> {
        if id.into() != Self::MESSAGE_ID { None } else { data.try_into().ok() }
    }
    fn new_remote(_id: impl Into<Id>, _dlc: usize) -> Option<Self> {
...
/// MSGID_0X1806E7F4
///
/// - Extended ID: 403105780 (0x1806e7f4)
/// - Size: 8 bytes
/// - Transmitter: BMS
///
...
impl Msgid0x1806e7f4 {
    ...
    pub fn set_pack_ccl(&mut self, value: f32) -> Result<(), CanError> {
        if value < 0_f32 || 0_f32 < value {
            return Err(CanError::ParameterOutOfRange {
                message_id: Msgid0x1806e7f4::MESSAGE_ID,
            });
        }
        let factor = 0.1_f32;
        let offset = 0_f32;
...
impl embedded_can::Frame for Msgid0x1806e7f4 {
    fn new(id: impl Into<Id>, data: &[u8]) -> Option<Self> {
        if id.into() != Self::MESSAGE_ID { None } else { data.try_into().ok() }
    }
    fn new_remote(_id: impl Into<Id>, _dlc: usize) -> Option<Self> {
...
/// MSGID_0X1806E5F4
///
/// - Extended ID: 403105268 (0x1806e5f4)
/// - Size: 8 bytes
/// - Transmitter: BMS
///
/// This ID Transmits at 808 ms.
...
impl Msgid0x1806e5f4 {
    ...
    pub fn set_pack_ccl(&mut self, value: f32) -> Result<(), CanError> {
        if value < 0_f32 || 0_f32 < value {
            return Err(CanError::ParameterOutOfRange {
                message_id: Msgid0x1806e5f4::MESSAGE_ID,
            });
        }
        let factor = 0.1_f32;
        let offset = 0_f32;
...
impl embedded_can::Frame for Msgid0x1806e5f4 {
    fn new(id: impl Into<Id>, data: &[u8]) -> Option<Self> {
        if id.into() != Self::MESSAGE_ID { None } else { data.try_into().ok() }
    }
    fn new_remote(_id: impl Into<Id>, _dlc: usize) -> Option<Self> {
...
/// MSGID_0X1806E9F4
///
/// - Extended ID: 403106292 (0x1806e9f4)
/// - Size: 8 bytes
/// - Transmitter: BMS
///
/// This ID Transmits at 808 ms.
...
impl Msgid0x1806e9f4 {
    ...
    pub fn set_pack_ccl(&mut self, value: f32) -> Result<(), CanError> {
        if value < 0_f32 || 0_f32 < value {
            return Err(CanError::ParameterOutOfRange {
                message_id: Msgid0x1806e9f4::MESSAGE_ID,
            });
        }
        let factor = 0.1_f32;
        let offset = 0_f32;
...
impl embedded_can::Frame for Msgid0x1806e9f4 {
    fn new(id: impl Into<Id>, data: &[u8]) -> Option<Self> {
        if id.into() != Self::MESSAGE_ID { None } else { data.try_into().ok() }
    }
    fn new_remote(_id: impl Into<Id>, _dlc: usize) -> Option<Self> {
...
impl M173ModulationAndFluxInfo {
    ...
    pub fn set_inv_iq_command(&mut self, value: f32) -> Result<(), CanError> {
        if value < -3276.8_f32 || 3276.7_f32 < value {
            return Err(CanError::ParameterOutOfRange {
                message_id: M173ModulationAndFluxInfo::MESSAGE_ID,
            });
        }
        let factor = 0.1_f32;
        let offset = 0_f32;
...
impl embedded_can::Frame for M173ModulationAndFluxInfo {
    fn new(id: impl Into<Id>, data: &[u8]) -> Option<Self> {
        if id.into() != Self::MESSAGE_ID { None } else { data.try_into().ok() }
    }
    fn new_remote(_id: impl Into<Id>, _dlc: usize) -> Option<Self> {
...
impl M172TorqueAndTimerInfo {
    ...
    pub fn set_inv_power_on_timer(&mut self, value: f32) -> Result<(), CanError> {
        if value < 0_f32 || 12884800_f32 < value {
            return Err(CanError::ParameterOutOfRange {
                message_id: M172TorqueAndTimerInfo::MESSAGE_ID,
            });
        }
        let factor = 0.003_f32;
        let offset = 0_f32;
...
impl embedded_can::Frame for M172TorqueAndTimerInfo {
    fn new(id: impl Into<Id>, data: &[u8]) -> Option<Self> {
        if id.into() != Self::MESSAGE_ID { None } else { data.try_into().ok() }
    }
    fn new_remote(_id: impl Into<Id>, _dlc: usize) -> Option<Self> {
...
impl M194ReadWriteParamResponse {
    ...
    pub fn set_inv_parameter_response_data(
        ...
        if value < -32768_i16 || 32767_i16 < value {
            return Err(CanError::ParameterOutOfRange {
                message_id: M194ReadWriteParamResponse::MESSAGE_ID,
            });
        }
        let factor = 1;
        let value = value
...
impl embedded_can::Frame for M194ReadWriteParamResponse {
    fn new(id: impl Into<Id>, data: &[u8]) -> Option<Self> {
        if id.into() != Self::MESSAGE_ID { None } else { data.try_into().ok() }
    }
    fn new_remote(_id: impl Into<Id>, _dlc: usize) -> Option<Self> {
...
impl M193ReadWriteParamCommand {
    ...
    pub fn set_vcu_inv_parameter_data(&mut self, value: i16) -> Result<(), CanError> {
        if value < -32768_i16 || 32767_i16 < value {
            return Err(CanError::ParameterOutOfRange {
                message_id: M193ReadWriteParamCommand::MESSAGE_ID,
            });
        }
        let factor = 1;
        let value = value
...
impl embedded_can::Frame for M193ReadWriteParamCommand {
    fn new(id: impl Into<Id>, data: &[u8]) -> Option<Self> {
        if id.into() != Self::MESSAGE_ID { None } else { data.try_into().ok() }
    }
    fn new_remote(_id: impl Into<Id>, _dlc: usize) -> Option<Self> {
...
impl M192CommandMessage {
    ...
    pub fn set_vcu_inv_torque_limit_command(
        ...
        if value < -3276.8_f32 || 3276.7_f32 < value {
            return Err(CanError::ParameterOutOfRange {
                message_id: M192CommandMessage::MESSAGE_ID,
            });
        }
        let factor = 0.1_f32;
        let offset = 0_f32;
    ...
    /// - Receivers: Vector__XXX
    #[inline(always)]
    pub fn vcu_inv_inverter_discharge(
        &self,
    ) -> M192CommandMessageVcuInvInverterDischarge {
        let signal = self.raw.view_bits::<Lsb0>()[41..42].load_le::<u8>();
        match signal {
            0 => M192CommandMessageVcuInvInverterDischarge::DischargeDisable,
            1 => {
                M192CommandMessageVcuInvInverterDischarge::DischargeEnableIfEepromParameterIsSet
            }
            _ => {
                M192CommandMessageVcuInvInverterDischarge::_Other(
                    self.vcu_inv_inverter_discharge_raw(),
                )
            }
        }
    }
    ...
    pub fn vcu_inv_inverter_enable(&self) -> M192CommandMessageVcuInvInverterEnable {
        ...
        match signal {
            ...
            _ => {
                M192CommandMessageVcuInvInverterEnable::_Other(
                    self.vcu_inv_inverter_enable_raw(),
                )
            }
        }
    }
    ...
    pub fn vcu_inv_direction_command(&self) -> M192CommandMessageVcuInvDirectionCommand {
        ...
        match signal {
            ...
            _ => {
                M192CommandMessageVcuInvDirectionCommand::_Other(
                    self.vcu_inv_direction_command_raw(),
                )
            }
        }
    }
...
impl embedded_can::Frame for M192CommandMessage {
    fn new(id: impl Into<Id>, data: &[u8]) -> Option<Self> {
        if id.into() != Self::MESSAGE_ID { None } else { data.try_into().ok() }
    }
    fn new_remote(_id: impl Into<Id>, _dlc: usize) -> Option<Self> {
...
impl M171FaultCodes {
    ...
    pub fn set_inv_run_fault_hi(&mut self, value: u16) -> Result<(), CanError> {
        if value < 0_u16 || 65535_u16 < value {
            return Err(CanError::ParameterOutOfRange {
                message_id: M171FaultCodes::MESSAGE_ID,
            });
        }
        let factor = 1;
        let value = value
...
impl embedded_can::Frame for M171FaultCodes {
    fn new(id: impl Into<Id>, data: &[u8]) -> Option<Self> {
        if id.into() != Self::MESSAGE_ID { None } else { data.try_into().ok() }
    }
    fn new_remote(_id: impl Into<Id>, _dlc: usize) -> Option<Self> {
...
impl M170InternalStates {
    ...
    pub fn new(
        ...
        inv_relay_5_status: bool,
        inv_relay_4_status: bool,
    ...
    /// - Receivers: Vector__XXX
    #[inline(always)]
    pub fn inv_limit_stall_burst_model(
        &self,
    ) -> M170InternalStatesInvLimitStallBurstModel {
        ...
        match signal {
            ...
            _ => {
                M170InternalStatesInvLimitStallBurstModel::_Other(
                    self.inv_limit_stall_burst_model_raw(),
                )
            }
        }
    }
    ...
    pub fn inv_burst_model_mode(&self) -> M170InternalStatesInvBurstModelMode {
        ...
        match signal {
            ...
            _ => {
                M170InternalStatesInvBurstModelMode::_Other(
                    self.inv_burst_model_mode_raw(),
                )
            }
        }
    }
    ...
    /// - Receivers: Vector__XXX
    #[inline(always)]
    pub fn inv_inverter_discharge_state(
        &self,
    ) -> M170InternalStatesInvInverterDischargeState {
        ...
        match signal {
            ...
            _ => {
                M170InternalStatesInvInverterDischargeState::_Other(
                    self.inv_inverter_discharge_state_raw(),
                )
            }
        }
    }
    ...
    pub fn inv_inverter_state(&self) -> M170InternalStatesInvInverterState {
        ...
        match signal {
            ...
            4 => M170InternalStatesInvInverterState::InternalState(4),
            5 => M170InternalStatesInvInverterState::InternalState(5),
            6 => M170InternalStatesInvInverterState::InternalState(6),
            7 => M170InternalStatesInvInverterState::InternalState(7),
            8 => M170InternalStatesInvInverterState::IdleRun,
            9 => M170InternalStatesInvInverterState::IdleStop,
            10 => M170InternalStatesInvInverterState::InternalState(10),
            11 => M170InternalStatesInvInverterState::InternState,
            12 => M170InternalStatesInvInverterState::InternalState(12),
            _ => {
                M170InternalStatesInvInverterState::_Other(self.inv_inverter_state_raw())
            }
        }
    }
...
impl embedded_can::Frame for M170InternalStates {
    fn new(id: impl Into<Id>, data: &[u8]) -> Option<Self> {
        if id.into() != Self::MESSAGE_ID { None } else { data.try_into().ok() }
    }
    fn new_remote(_id: impl Into<Id>, _dlc: usize) -> Option<Self> {
...
impl From<M170InternalStatesInvInverterState> for u8 {
    fn from(val: M170InternalStatesInvInverterState) -> u8 {
        match val {
            ...
            M170InternalStatesInvInverterState::InternalState(v) => v,
...
impl M169InternalVoltages {
    ...
    pub fn set_inv_ref_voltage_12_0(&mut self, value: f32) -> Result<(), CanError> {
        if value < -327.68_f32 || 327.67_f32 < value {
            return Err(CanError::ParameterOutOfRange {
                message_id: M169InternalVoltages::MESSAGE_ID,
            });
        }
        let factor = 0.01_f32;
        let offset = 0_f32;
...
impl embedded_can::Frame for M169InternalVoltages {
    fn new(id: impl Into<Id>, data: &[u8]) -> Option<Self> {
        if id.into() != Self::MESSAGE_ID { None } else { data.try_into().ok() }
    }
    fn new_remote(_id: impl Into<Id>, _dlc: usize) -> Option<Self> {
...
impl M168FluxIdIqInfo {
    ...
    pub fn set_inv_iq(&mut self, value: f32) -> Result<(), CanError> {
        if value < -3276.8_f32 || 3276.7_f32 < value {
            return Err(CanError::ParameterOutOfRange {
                message_id: M168FluxIdIqInfo::MESSAGE_ID,
            });
        }
        let factor = 0.1_f32;
        let offset = 0_f32;
...
impl embedded_can::Frame for M168FluxIdIqInfo {
    fn new(id: impl Into<Id>, data: &[u8]) -> Option<Self> {
        if id.into() != Self::MESSAGE_ID { None } else { data.try_into().ok() }
    }
    fn new_remote(_id: impl Into<Id>, _dlc: usize) -> Option<Self> {
...
impl M167VoltageInfo {
    ...
    pub fn set_inv_vbc_vq_voltage(&mut self, value: f32) -> Result<(), CanError> {
        if value < -3276.8_f32 || 3276.7_f32 < value {
            return Err(CanError::ParameterOutOfRange {
                message_id: M167VoltageInfo::MESSAGE_ID,
            });
        }
        let factor = 0.1_f32;
        let offset = 0_f32;
...
impl embedded_can::Frame for M167VoltageInfo {
    fn new(id: impl Into<Id>, data: &[u8]) -> Option<Self> {
        if id.into() != Self::MESSAGE_ID { None } else { data.try_into().ok() }
    }
    fn new_remote(_id: impl Into<Id>, _dlc: usize) -> Option<Self> {
...
impl M166CurrentInfo {
    ...
    pub fn set_inv_dc_bus_current(&mut self, value: f32) -> Result<(), CanError> {
        if value < -3276.8_f32 || 3276.7_f32 < value {
            return Err(CanError::ParameterOutOfRange {
                message_id: M166CurrentInfo::MESSAGE_ID,
            });
        }
        let factor = 0.1_f32;
        let offset = 0_f32;
...
impl embedded_can::Frame for M166CurrentInfo {
    fn new(id: impl Into<Id>, data: &[u8]) -> Option<Self> {
        if id.into() != Self::MESSAGE_ID { None } else { data.try_into().ok() }
    }
    fn new_remote(_id: impl Into<Id>, _dlc: usize) -> Option<Self> {
...
impl M165MotorPositionInfo {
    ...
    pub fn set_inv_delta_resolver_filtered(
        ...
        if value < -3276.8_f32 || 3276.7_f32 < value {
            return Err(CanError::ParameterOutOfRange {
                message_id: M165MotorPositionInfo::MESSAGE_ID,
            });
        }
        let factor = 0.1_f32;
        let offset = 0_f32;
...
impl embedded_can::Frame for M165MotorPositionInfo {
    fn new(id: impl Into<Id>, data: &[u8]) -> Option<Self> {
        if id.into() != Self::MESSAGE_ID { None } else { data.try_into().ok() }
    }
    fn new_remote(_id: impl Into<Id>, _dlc: usize) -> Option<Self> {
...
impl M164DigitalInputStatus {
    ...
    pub fn new(
        ...
        inv_digital_input_6: bool,
        inv_digital_input_5: bool,
        inv_digital_input_4: bool,
        inv_digital_input_3: bool,
...
impl embedded_can::Frame for M164DigitalInputStatus {
    fn new(id: impl Into<Id>, data: &[u8]) -> Option<Self> {
        if id.into() != Self::MESSAGE_ID { None } else { data.try_into().ok() }
    }
    fn new_remote(_id: impl Into<Id>, _dlc: usize) -> Option<Self> {
...
impl M163AnalogInputVoltages {
    ...
    pub fn new(
        ...
        inv_analog_input_4: f32,
        inv_analog_input_3: f32,
    ...
    pub fn set_inv_analog_input_6(&mut self, value: f32) -> Result<(), CanError> {
        if value < 0_f32 || 10.23_f32 < value {
            return Err(CanError::ParameterOutOfRange {
                message_id: M163AnalogInputVoltages::MESSAGE_ID,
            });
        }
        let factor = 0.01_f32;
        let offset = 0_f32;
...
impl embedded_can::Frame for M163AnalogInputVoltages {
    fn new(id: impl Into<Id>, data: &[u8]) -> Option<Self> {
        if id.into() != Self::MESSAGE_ID { None } else { data.try_into().ok() }
    }
    fn new_remote(_id: impl Into<Id>, _dlc: usize) -> Option<Self> {
...
impl embedded_can::Frame for M162TemperatureSet3 {
    fn new(id: impl Into<Id>, data: &[u8]) -> Option<Self> {
        if id.into() != Self::MESSAGE_ID { None } else { data.try_into().ok() }
    }
    fn new_remote(_id: impl Into<Id>, _dlc: usize) -> Option<Self> {
...
impl embedded_can::Frame for M161TemperatureSet2 {
    fn new(id: impl Into<Id>, data: &[u8]) -> Option<Self> {
        if id.into() != Self::MESSAGE_ID { None } else { data.try_into().ok() }
    }
    fn new_remote(_id: impl Into<Id>, _dlc: usize) -> Option<Self> {
...
impl M160TemperatureSet1 {
    ...
    pub fn set_inv_gate_driver_board_temp(
        ...
        if value < -3276.8_f32 || 3276.7_f32 < value {
            return Err(CanError::ParameterOutOfRange {
                message_id: M160TemperatureSet1::MESSAGE_ID,
            });
        }
        let factor = 0.1_f32;
        let offset = 0_f32;
...
impl embedded_can::Frame for M160TemperatureSet1 {
    fn new(id: impl Into<Id>, data: &[u8]) -> Option<Self> {
        if id.into() != Self::MESSAGE_ID { None } else { data.try_into().ok() }
    }
    fn new_remote(_id: impl Into<Id>, _dlc: usize) -> Option<Self> {
...
impl M174FirmwareInfo {
    ...
    pub fn set_inv_date_code_yyyy(&mut self, value: u16) -> Result<(), CanError> {
        if value < 0_u16 || 65535_u16 < value {
            return Err(CanError::ParameterOutOfRange {
                message_id: M174FirmwareInfo::MESSAGE_ID,
            });
        }
        let factor = 1;
        let value = value
...
impl embedded_can::Frame for M174FirmwareInfo {
    fn new(id: impl Into<Id>, data: &[u8]) -> Option<Self> {
        if id.into() != Self::MESSAGE_ID { None } else { data.try_into().ok() }
    }
    fn new_remote(_id: impl Into<Id>, _dlc: usize) -> Option<Self> {
...
impl M175DiagDataMessage {
    ...
    pub fn inv_diag_segment(
        &mut self,
    ) -> Result<M175DiagDataMessageInvDiagSegmentIndex, CanError> {
        match self.inv_diag_segment_raw() {
            0 => {
                Ok(
                    M175DiagDataMessageInvDiagSegmentIndex::M0(M175DiagDataMessageInvDiagSegmentM0 {
                        raw: self.raw,
                    }),
                )
            }
            1 => {
                Ok(
                    M175DiagDataMessageInvDiagSegmentIndex::M1(M175DiagDataMessageInvDiagSegmentM1 {
                        raw: self.raw,
                    }),
                )
            }
            2 => {
                Ok(
                    M175DiagDataMessageInvDiagSegmentIndex::M2(M175DiagDataMessageInvDiagSegmentM2 {
                        raw: self.raw,
                    }),
                )
            }
            3 => {
                Ok(
                    M175DiagDataMessageInvDiagSegmentIndex::M3(M175DiagDataMessageInvDiagSegmentM3 {
                        raw: self.raw,
                    }),
                )
            }
            4 => {
                Ok(
                    M175DiagDataMessageInvDiagSegmentIndex::M4(M175DiagDataMessageInvDiagSegmentM4 {
                        raw: self.raw,
                    }),
                )
            }
            5 => {
                Ok(
                    M175DiagDataMessageInvDiagSegmentIndex::M5(M175DiagDataMessageInvDiagSegmentM5 {
                        raw: self.raw,
                    }),
                )
            }
            multiplexor => {
                Err(CanError::InvalidMultiplexor {
                    message_id: M175DiagDataMessage::MESSAGE_ID,
                    multiplexor: multiplexor.into(),
                })
            }
        }
    ...
    pub fn set_m0(
        &mut self,
        value: M175DiagDataMessageInvDiagSegmentM0,
    ) -> Result<(), CanError> {
        let b0 = BitArray::<_, LocalBits>::new(self.raw);
        let b1 = BitArray::<_, LocalBits>::new(value.raw);
        self.raw = b0.bitor(b1).into_inner();
    ...
    pub fn set_m1(
        &mut self,
        value: M175DiagDataMessageInvDiagSegmentM1,
    ) -> Result<(), CanError> {
        let b0 = BitArray::<_, LocalBits>::new(self.raw);
        let b1 = BitArray::<_, LocalBits>::new(value.raw);
        self.raw = b0.bitor(b1).into_inner();
    ...
    pub fn set_m2(
        &mut self,
        value: M175DiagDataMessageInvDiagSegmentM2,
    ) -> Result<(), CanError> {
        let b0 = BitArray::<_, LocalBits>::new(self.raw);
        let b1 = BitArray::<_, LocalBits>::new(value.raw);
        self.raw = b0.bitor(b1).into_inner();
    ...
    pub fn set_m3(
        &mut self,
        value: M175DiagDataMessageInvDiagSegmentM3,
    ) -> Result<(), CanError> {
        let b0 = BitArray::<_, LocalBits>::new(self.raw);
        let b1 = BitArray::<_, LocalBits>::new(value.raw);
        self.raw = b0.bitor(b1).into_inner();
    ...
    pub fn set_m4(
        &mut self,
        value: M175DiagDataMessageInvDiagSegmentM4,
    ) -> Result<(), CanError> {
        let b0 = BitArray::<_, LocalBits>::new(self.raw);
        let b1 = BitArray::<_, LocalBits>::new(value.raw);
        self.raw = b0.bitor(b1).into_inner();
    ...
    pub fn set_m5(
        &mut self,
        value: M175DiagDataMessageInvDiagSegmentM5,
    ) -> Result<(), CanError> {
        let b0 = BitArray::<_, LocalBits>::new(self.raw);
        let b1 = BitArray::<_, LocalBits>::new(value.raw);
        self.raw = b0.bitor(b1).into_inner();
...
impl embedded_can::Frame for M175DiagDataMessage {
    fn new(id: impl Into<Id>, data: &[u8]) -> Option<Self> {
        if id.into() != Self::MESSAGE_ID { None } else { data.try_into().ok() }
    }
    fn new_remote(_id: impl Into<Id>, _dlc: usize) -> Option<Self> {
...
pub enum M175DiagDataMessageInvDiagSegmentIndex {
...
#[derive(Default)]
pub struct M175DiagDataMessageInvDiagSegmentM0 {
    raw: [u8; 8],
}
#[allow(
    clippy::absurd_extreme_comparisons,
...
#[derive(Default)]
pub struct M175DiagDataMessageInvDiagSegmentM1 {
    raw: [u8; 8],
}
#[allow(
    clippy::absurd_extreme_comparisons,
...
#[derive(Default)]
pub struct M175DiagDataMessageInvDiagSegmentM2 {
    raw: [u8; 8],
}
#[allow(
    clippy::absurd_extreme_comparisons,
...
#[derive(Default)]
pub struct M175DiagDataMessageInvDiagSegmentM3 {
    raw: [u8; 8],
}
#[allow(
    clippy::absurd_extreme_comparisons,
...
#[derive(Default)]
pub struct M175DiagDataMessageInvDiagSegmentM4 {
    raw: [u8; 8],
}
#[allow(
    clippy::absurd_extreme_comparisons,
...
#[derive(Default)]
pub struct M175DiagDataMessageInvDiagSegmentM5 {
    raw: [u8; 8],
}
#[allow(
    clippy::absurd_extreme_comparisons,
...
impl BmsCurrentLimit {
    ...
    pub fn set_bms_max_charge_current(&mut self, value: u16) -> Result<(), CanError> {
        if value < 0_u16 || 1000_u16 < value {
            return Err(CanError::ParameterOutOfRange {
                message_id: BmsCurrentLimit::MESSAGE_ID,
            });
        }
        let factor = 1;
        let value = value
...
impl embedded_can::Frame for BmsCurrentLimit {
    fn new(id: impl Into<Id>, data: &[u8]) -> Option<Self> {
        if id.into() != Self::MESSAGE_ID { None } else { data.try_into().ok() }
    }
    fn new_remote(_id: impl Into<Id>, _dlc: usize) -> Option<Self> {
...
impl M176FastInfo {
    ...
    pub fn set_inv_fast_dc_bus_voltage(&mut self, value: f32) -> Result<(), CanError> {
        if value < -3276.8_f32 || 3276.7_f32 < value {
            return Err(CanError::ParameterOutOfRange {
                message_id: M176FastInfo::MESSAGE_ID,
            });
        }
        let factor = 0.1_f32;
        let offset = 0_f32;
...
impl embedded_can::Frame for M176FastInfo {
    fn new(id: impl Into<Id>, data: &[u8]) -> Option<Self> {
        if id.into() != Self::MESSAGE_ID { None } else { data.try_into().ok() }
    }
    fn new_remote(_id: impl Into<Id>, _dlc: usize) -> Option<Self> {
...
impl M177TorqueCapability {
    ...
    pub fn set_inv_torque_capability_regen(
        ...
        if value < -3276.8_f32 || 0_f32 < value {
            return Err(CanError::ParameterOutOfRange {
                message_id: M177TorqueCapability::MESSAGE_ID,
            });
        }
        let factor = 0.1_f32;
        let offset = 0_f32;
...
impl embedded_can::Frame for M177TorqueCapability {
    fn new(id: impl Into<Id>, data: &[u8]) -> Option<Self> {
        if id.into() != Self::MESSAGE_ID { None } else { data.try_into().ok() }
    }
    fn new_remote(_id: impl Into<Id>, _dlc: usize) -> Option<Self> {
...
/// Status
///
/// - Extended ID: 419385573 (0x18ff50e5)
/// - Size: 8 bytes
